...
<header>
    <div class="hero-img">
        ...
        <div class="hero-text">
            ...
            <a href="#student" class="button">Dane studenta</a>
        </div>
    </div>
</header>

<main>
    <section id="student" class="main">
        <div class="container">
            <h2>Dane studenta</h2>
            <div class="underline"></div>
            <div class="student-box">
                <p><span>Imię:</span>Sebastian</p>
                <p><span>Nazwisko:</span>Cichy</p>
                <p><span>Nr indeksu:</span>150676</p>
                <p><span>Semestr:</span>IV</p>
            </div>
        </div>
    </section>
</main>
